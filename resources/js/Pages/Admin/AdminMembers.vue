      ...
      <div class="p-4 md:p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center justify-between">
             <div>
               <p class="text-xs text-gray-400 font-bold uppercase tracking-widest mb-1">Total Akun User</p>
               <p class="text-3xl font-black text-slate-800">{{ usersList.length }}</p>
             </div>
          ...
          <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center justify-between">
             <div>
               <p class="text-xs text-gray-400 font-bold uppercase tracking-widest mb-1">Member Aktif</p>
               <p class="text-3xl font-black text-indigo-600">{{ usersList.filter(u => u.is_member).length }}</p>
             </div>
          ...
          <div class="relative group">
            ...
            <input
              ...
              class="block w-full h-full pl-12 pr-4 py-4 border border-gray-200 rounded-2xl bg-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all shadow-sm"
            />
          </div>
        </div>
